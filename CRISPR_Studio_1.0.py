...
# The function mclCluster runs the mcl program to form clusters of spacers
...
# And the function attrivuteClsColor attributes two random numbers to each cluster
...
# The functions seriation and classifyCluster performs a clustering of entire CRISPR loci to sort samples according
# to their whole array similarities.
